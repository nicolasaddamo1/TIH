            ...
            <div>
              {selectedMetric === 'ventas' && (
                <div className="space-y-4">
                  ...
                  <p>Total Ventas: {metricsData.totalVentas}</p>
                  {/* Otros datos de ventas */}
                </div>
              )}
              {selectedMetric === 'comisiones' && (
                <div className="space-y-4">
                  <h3 className="text-xl font-semibold">Resumen de Comisiones</h3>
                  <p>Total Comisiones: {metricsData.totalComisiones}</p>
                  {/* Otros datos de comisiones */}
                </div>
              )}
              {selectedMetric === 'pagos' && (
                <div className="space-y-4">
                  <h3 className="text-xl font-semibold">Resumen de Pagos</h3>
                  <p>Total Pagos: {metricsData.totalPagos}</p>
